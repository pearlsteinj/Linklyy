...
#import "LNKFacetimeSettingsViewController.h"
...
@interface LNKFacetimeSettingsViewController ()
@property(nonatomic) NSString *selectedPhoneNum;
@end

@implementation LNKFacetimeSettingsViewController
objection_register(LNKFacetimeSettingsViewController)
