...
#import "LNKSMSSettingsViewController.h"
...
@interface LNKSMSSettingsViewController ()
@property(nonatomic) NSString *selectedPhoneNum;
@end

@implementation LNKSMSSettingsViewController
objection_register(LNKSMSSettingsViewController)
