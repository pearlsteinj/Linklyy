//
//  LNKSpotifySettingsViewController.h
//  Linklyy
//
...
@interface LNKEmailViewController : UIViewController
...
@property (strong, nonatomic) IBOutlet UITextField *subjectLine;
@property (strong, nonatomic) IBOutlet UITextField *bodyText;
